...
def generate(hybrid_html=""):
    ...
    for r in range(num_rows):
        ...
        rows_html += f'<div style="display: grid; gap: 16px; grid-template-columns: {col_layout}; height: 100%; min-height: 0; overflow: hidden;">'
        placed_hybrid = False
        for _ in range(len(cols)):
            if r == 0:
                ...
                comp_type = random.choices(
                    ["gallery", "complex_para", "table", "figure"], weights=[0.4, 0.35, 0.1, 0.15]
                )[0]
